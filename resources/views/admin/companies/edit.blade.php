<x-app-layout>
    <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <a href="{{ route('admin.companies.users.create', $company) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-violet-600 px-3 py-1.5 text-sm font-medium text-white shadow-sm transition hover:bg-violet-700">
