...
return [
    ...
    'reports' => [
        ...
        'shifts' => [
            'title' => 'Shifts',
            'subtitle' => 'Start/end a shift and reconcile cash',
            'open' => 'Shift Open',
            'closed' => 'No Active Shift',
            'no_open_shift' => 'Click "Start Shift" to begin a new shift record.',
            'start_shift' => 'Start Shift',
            'end_shift' => 'End Shift',
            'opened_at' => 'Opened At',
            'closed_at' => 'Closed At',
            'cash_so_far' => 'Cash Sales So Far',
            'expected_cash' => 'Expected Cash',
            'actual_cash' => 'Actual Cash',
            'difference' => 'Difference',
            'note' => 'Note',
            'history_title' => 'Shift History',
            'no_data' => 'No shifts recorded yet.',
            'already_open' => 'A shift is already open.',
            'none_open' => 'No active shift to end.',
