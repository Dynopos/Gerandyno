...
return [
    ...
    'admin' => [
        ...
        'companies' => [
            ...
            'sst_registered' => 'SST registered (service tax)',
            'sst_registered_hint' => 'Tick only if this shop is registered and remits SST to Customs. When ticked, tax is deducted from profit because it is not the shop\'s income, and the Tax (SST) tab appears for them.',
            'sst_no' => 'SST Registration No.',
            'ssm_no' => 'SSM Registration No.',
            'address' => 'Address',
            'users' => 'Users',
            'salesplay_accounts' => 'SalesPlay Accounts',
            'actions' => 'Actions',
