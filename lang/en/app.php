...
return [
    ...
    'nav' => [
        ...
        'products' => 'Products',
        'customers' => 'Customers',
        'inventory_stock' => 'Stock Balance',
        'inventory_stock_ins' => 'Stock In',
        'profile' => 'Profile',
        'logout' => 'Log Out',
        'open_menu' => 'Open menu',
    ...
    'reports' => [
        ...
        'inventory' => [
            'stock' => [
                'title' => 'Stock Balance',
                'subtitle' => 'Current stock quantity by product',
                'search_placeholder' => 'Search name, SKU or barcode...',
                'no_data' => 'No stock data yet.',
                'product_name' => 'Product Name',
                'sku' => 'SKU',
            ...
            'stock_ins' => [
                'title' => 'Stock In',
                'subtitle' => 'Stock received (GRN) records from SalesPlay',
                'search_placeholder' => 'Search supplier or invoice no...',
                'no_data' => 'No stock-in records yet.',
                'received_at' => 'Received Date',
                'supplier' => 'Supplier',
                'invoice_no' => 'Invoice No.',
                'items' => 'Items',
                'total' => 'Total',
                'back_to_list' => '&larr; Stock In',
                'item_name' => 'Item Name',
                'quantity' => 'Quantity',
                'unit_cost' => 'Unit Cost',
                'not_available' => 'Not available',
