...
return [
    ...
    'admin' => [
        'companies' => [
            'title' => 'Companies',
            'subtitle' => 'Every customer company on DynoPOS Cloud Report.',
            'create' => 'New Company',
            ...
            'status' => 'Status',
            'users_count' => 'Users',
            'accounts_count' => 'SalesPlay Accounts',
        ...
        'users' => [
            ...
            'subtitle' => 'Users who can log in and view this company\'s reports.',
            'add' => 'Add User',
            'name' => 'Name',
            'email' => 'Email',
            'password' => 'Password',
            'password_confirmation' => 'Confirm Password',
            'empty' => 'No users yet for this company.',
        ...
        'accounts' => [
            ...
            'subtitle' => 'API credentials and sync status per shop.',
            'create' => 'New SalesPlay Account',
            'create_title' => 'New SalesPlay Account',
            'edit_title' => 'Edit SalesPlay Account',
            'company' => 'Company',
            'shop_name' => 'Shop Name',
            'shop_id' => 'SalesPlay Shop ID',
            'api_token' => 'API Token',
            'api_token_help' => 'Stored encrypted and never shown again after saving.',
            'api_token_keep' => 'Leave blank to keep the current token.',
            'api_token_set' => 'A token is saved for this account.',
            'sync' => 'Sync',
            'sync_enabled' => 'Sync enabled',
            'sync_disabled' => 'Sync disabled',
            'last_synced' => 'Last Synced',
            'last_sync_status' => 'Last Sync',
            'last_sync_error' => 'Last Sync Error',
            'never_synced' => 'Never synced',
            'empty' => 'No SalesPlay accounts yet.',
            'created' => 'SalesPlay account created.',
            'updated' => 'SalesPlay account updated.',
        ],
        'status' => [
            'active' => 'Active',
            'inactive' => 'Inactive',
